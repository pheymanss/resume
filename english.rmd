...
Equipped with pure mathematics-level of rigour, I found a deep passion for statistics and recognized the impact machine learning models can and will have in our lives. Experienced in supervised and unsupervised big data problems, I strive to leverage my theoretical and programming skills to improve people's lives.
...
* Author and maintainer of [{chronicle}](https://CRAN.R-project.org/package=chronicle), an R package for creating frictionless R Markdown reports, with a sequential syntax inspired by keras/ggplot. Successfully submitted to CRAN on January 21st, 2021, and presented at the Virtual R Users Meetup ConectaR 2021 and useR! Conference 2021. 
...
* Development of a dynamic SQL querying tool, automating query design for all our current target definition approaches.
...
* Designed and imparted R trainings for non-specialist teams in Brazil, México, Colombia, Uruguay, Argentina and Costa Rica, along monthly trainings imparted to my own specialist team.
